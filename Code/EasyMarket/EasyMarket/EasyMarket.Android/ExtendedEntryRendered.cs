...
[assembly: ExportRenderer(typeof(ExtendedEntry), typeof(ExtendedEntryRendered))]
namespace EasyMarket.Droid
{
    class ExtendedEntryRendered : EntryRenderer
    {
        ...
        private void SetBorder(ExtendedEntry view)
        {
            ...
            {
                var shape = new ShapeDrawable(new RoundRectShape(new float[] { 10, 10, 10, 10, 10, 10, 10, 10 }, new RectF(10, 10, 10, 10), new float[] { 10, 10, 10, 10, 10, 10, 10, 10 }));
                shape.Paint.Color = view.BorderColor.ToAndroid();
                shape.SetBounds(220, 20, 300, 100);
                shape.Paint.SetStyle(Paint.Style.Stroke);
                shape.Paint.StrokeCap = Paint.Cap.Round;
